...
class DistributedMistralModel(DefaultRevisionMixin, FromPretrainedMixin, PTuneMixin, MistralModel):
    _keys_to_ignore_on_load_missing = PTuneMixin._keys_to_ignore_on_load_missing
    _keys_to_ignore_on_load_unexpected = [r"^model\.layers\."]

    config_class = DistributedMistralConfig

    def __init__(self, config: DistributedMistralConfig, *, dht: Optional[DHT] = None):
...
class DistributedMistralForCausalLM(FromPretrainedMixin, RemoteGenerationMixin, MistralForCausalLM):
    ...
    @property
    def transformer(self) -> DistributedMistralModel:
        return self.model
